...
public class Panier {
	...
	if (fruits.size() + 1 > contenanceMax)
	{
	...
	try{
		...
		System.out.println("Erreur PanierVide capturée"	);
	}

	try{ 
		p.ajout(f); 
		System.out.println("Une fraise a été ajoutée au panier");
	}
	catch(PanierPleinException ex) { 
